                ...
                {isHome && (
                    <form className='md:w-1/2 2xl:w-1/3 bg-orange-400 my-32 p-10 rounded-lg shadow space-y-6' action="" onSubmit={handleSubmit}>
                        <div className='space-y-4'>
                            ...
                            <input className='p-3 w-full rounded focus:outline-none' placeholder='Nombre o Ingrediente, Ej. Vodka, Tequila, Café' type="text" name="ingredient" id="ingredient" onChange={handleChange} value={searchFilters.ingredient}/>
                        </div>
                        <div className='space-y-4'>
                            <label className='block text-white uppercase font-extrabold text-lg' htmlFor="category">Categoria</label>
                            <select className='p-3 w-full rounded focus:outline-none' id='category' name='category' onChange={handleChange} value={searchFilters.category}>
                        ...
                        <input type="submit" value='Buscar Recetas' className='cursor-pointer bg-orange-800 hover:bg-orange-900 text-white font-extrabold rounded-lg uppercase w-full p-2'/>
                    </form>
                )}
            </div>
        </header>
